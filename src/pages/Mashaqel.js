        ...
        <div className="ag-format-container">
          <ul className="ag-offer_list">
            ...
            /> */}
                ...
                <div className="ag-offer_title">اقتصاد مراقبت</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            /> */}
                ...
                <div className="ag-offer_title "> فروش، بازاریابی و محتوا </div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            /> */}
                ...
                <div className="ag-offer_title">توسعه محصولات</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            /> */}
                ...
                <div className="ag-offer_title text-blue-700"></div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            /> */}
                ...
                <div className="ag-offer_title">کسب و کار فرهنگ</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            ...
            /> */}
                ...
                <div className="ag-offer_title">مهندس و رایانش ابری</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            ...
            /> */}
                ...
                <div className="ag-offer_title">داد‌ها و هوش مصنوعی</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            ...
            /> */}
                  ...
                  <div className="ag-offer_title">بازگشت به پنچره واحد </div>
                </div>
                <div className="ag-offer_hidden-item">
