          ...
          <ul className="ag-offer_list">
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title"> طرح مشاور </div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title">مراقبت سلامت</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            <li className="ag-offer_item  bg-blend-multiply">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title text-blue-700">هدایت شغلی</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title">سرباز مهارت</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title"> کمک پرستاری </div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title">صا ایران</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
            ...
            <li className="ag-offer_item">
              <Link to="/">
                ...
                /> */}
                  ...
                  <div className="ag-offer_title"> بازگشت به پنجره واحد </div>
                </div>
                <div className="ag-offer_hidden-item">
