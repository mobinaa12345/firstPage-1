          ...
          <ul className="ag-offer_list">
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title font-bold justify-center "></div>
              </div>
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title "> </div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title">آموزش مجازی جهاددانشگاهی</div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
            ...
            <li className="ag-offer_item">
              <div className="ag-offer_visible-item">
                ...
                <div className="ag-offer_title"> سامانه آزمون </div>
              </div>
              <div className="ag-offer_hidden-item">
                {/* <p className="ag-offer_text">
